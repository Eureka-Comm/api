...
public class RTrapezoidal extends MembershipFunction {
    @NotNull
    protected Double a;
    @NotNull
    protected Double b;
    public RTrapezoidal(){
        super(MembershipFunctionType.RTRAPEZOIDAL);
    }
    @Override
    public com.castellanos94.fuzzylogicgp.membershipfunction.MembershipFunction toInternalObject() {
        return new com.castellanos94.fuzzylogicgp.membershipfunction.RTrapezoidal(a,b);
    }
